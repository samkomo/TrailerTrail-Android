package com.example.trailertrail;
...
import com.example.controllers.ServiceHandler;
...
public class Login extends Activity {
	...
	String name, password, responce, regno;
	int resp;
		...
		protected Void doInBackground(Void... params) {
			...
			if (jsonStr != null) {
				try {
					...
					regno = jsonObj.getString(TAG_REGNO);
...
//				Log.d("Student regno", regno);
				...
				if (resp == 1) {
					...
					intent.putExtra(TAG_REGNO, regno);
					startActivity(intent);
				} else {
