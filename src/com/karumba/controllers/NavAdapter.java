...
public class NavAdapter extends BaseAdapter implements ListAdapter {
    private final Activity activity;
    private final JSONArray jsonArray;
    


    public NavAdapter(Activity activity, JSONArray jsonArray) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tvName = (TextView) convertView.findViewById(R.id.drawer_title); // title
        ImageView tvImage = (ImageView) convertView.findViewById(R.id.drawer_icon); // title
...
//        tvPrice.setTypeface(Fonting.getFont(parent.getContext(), Fonting.KEY_LIGHT));
        ...
        if (null != json_data) {
            try {
                String strName = json_data.getString("mall_name");
                String strImage = json_data.getString("mall_logo");
